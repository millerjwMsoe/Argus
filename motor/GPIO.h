...
private:
	...
	ofstream *outputValueFile;	/**< The output file which handles the value for the given device. */
	ifstream *inputValueFile; /** The file that will be read to obtain the value on the given device. */
...
public:
	...
	virtual int waitForEdge(int maxWait); // waits until button is pressed up to a maximum value.
